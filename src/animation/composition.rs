...
pub trait Composition {
    fn chain(self, other: impl Animation + 'static) -> Chain;
}

impl<T: Animation + 'static> Composition for T {
    fn chain(self, other: impl Animation + 'static) -> Chain {
...
impl Chain {
    ...
    pub fn append(&mut self, other: impl Animation + 'static) {
    ...
    pub fn chain(mut self, other: impl Animation + 'static) -> Self {
        self.append(other);
        self
    }
}
