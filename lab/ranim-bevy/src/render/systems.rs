...
use super::{
    ...
    utils::{
        basis_from_normal, resize_f32_by_sample, resize_vec4_by_sample, vitem_normal_from_points,
    },
};
...
pub(crate) fn prepare_ranim_vitem_buffers(
    ...
    let Some((item_infos, planes, points, fill_rgbas, stroke_rgbas, stroke_widths, instances)) =
        buffers
            .item_infos
            .buffer()
