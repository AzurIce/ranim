...
use glam::vec2;
use ranim::{
    animation::creation, color::palettes::manim::WHITE, prelude::*,
    rabject::rabject2d::vmobject::svg::Svg, scene::SceneBuilder, typst_svg,
    utils::get_texture_data,
};
...
fn main() {
    ...
    let mut letter_r = Svg::from_svg(&typst_svg!(
        r##"
