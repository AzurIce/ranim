...
export interface InitOutput {
  ...
  readonly closure10255_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd954d76c089528e0: (a: number, b: number) => void;
  readonly closure10257_externref_shim: (a: number, b: number, c: any, d: any) => void;
  readonly closure10448_externref_shim: (a: number, b: number, c: any) => void;
