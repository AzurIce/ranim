...
export const closure10370_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h67e5c98749e60a5d: (a: number, b: number) => void;
export const closure10373_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure10570_externref_shim: (a: number, b: number, c: any) => void;
