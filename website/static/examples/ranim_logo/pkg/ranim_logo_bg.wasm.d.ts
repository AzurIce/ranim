...
export const closure10285_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd954d76c089528e0: (a: number, b: number) => void;
export const closure10287_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure10478_externref_shim: (a: number, b: number, c: any) => void;
